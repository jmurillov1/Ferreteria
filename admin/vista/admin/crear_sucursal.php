...
<body>
    ...
    <header class="cab">
        <h1>Insertar Nueva Sucursal</h1>
    </header>
    <form id="form" method="POST" action="../../controladores/admin/crear_sucursal.php">
        <div class=" parte1">
            <label for="direccion">Dirección(*)</label>
            <input class="in" type="text" id="direccion" name="direccion" value=""
                placeholder="Ingrese la sucursal ..." />
            <span id="mensajeSucursal" class="error"></span>
            <br>
            <label for="telefono">Teléfono(*)</label>
            <input class="in" type="text" id="telefono" name="telefono" value=""
