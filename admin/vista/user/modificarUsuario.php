...
<head>
    <meta charset="UTF-8">
    <script type="text/javascript" src="../../../public/vista/js/funciones.js"></script>
...
<body>
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ?>
            <section id="form">
            <form id="formulario01" method="POST" action="../../controladores/user/modificarUsuario.php" enctype="multipart/form-data">
